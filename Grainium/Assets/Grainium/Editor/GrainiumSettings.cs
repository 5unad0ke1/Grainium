...
namespace Grainium.EditorExtensions
{
    public sealed class GrainiumSettings : ScriptableObject
    {
        ...
        [SerializeField] private bool _showChildCount = true;
        ...
        public bool ShowChildCount => _showChildCount;
        ...
        private static void OnGUI()
        {
            ...
            var showChildCount = serializedObject.FindProperty("_showChildCount");
            EditorGUILayout.PropertyField(showChildCount);
